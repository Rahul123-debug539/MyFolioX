    ...
    <section className="home">
      ...
      <div className="hero-content">
        ...
        <p className="subtitle">
          A modern portfolio generator where developers can{" "}
          <strong>design</strong>, <strong>preview</strong>, and{" "}
          <strong>download</strong> their personal portfolios —{" "}
          <em>instantly</em>, <em>beautifully</em>, and{" "}
          <em>without writing code</em>.
        </p>
        <Link to="/templateChooser">
          <button className="cta-button">Choose Template</button>
        </Link>
      </div>
    </section>
  );
